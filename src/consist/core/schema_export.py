    ...
    *,
    ...
    for row in export_fields:
        ...
        if needs_sa_column:
            ...
            field_rhs = f"Field(sa_column=Column({column_name_repr}, {col_type_expr}, nullable={nullable_expr}))"
            if row.nullable:
                field_rhs = f"Field(default=None, sa_column=Column({column_name_repr}, {col_type_expr}, nullable=True))"
    ...
    header_comment = (
        ...
        "# TODO: Add primary keys, foreign keys, indexes, and relationships.\n"
