...
- Ibis query bridge: [`consist.ibis_connection`](api_helpers.md#consist.api.ibis_connection), [`consist.ibis_view`](api_helpers.md#consist.api.ibis_view) (install with `consist[ibis]`)
