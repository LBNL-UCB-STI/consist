...
If you already know the content hash (for example, after copying or moving a file), you can pass `content_hash=` to `log_artifact` to reuse it and skip hashing the path on disk.
